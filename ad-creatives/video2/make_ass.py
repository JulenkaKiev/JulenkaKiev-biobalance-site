...
words = json.load(open("/Users/juliaknyazskaya/glp1-guide-site/ad-creatives/video2/voice/words.json"))
...
with open("/Users/juliaknyazskaya/glp1-guide-site/ad-creatives/video2/captions.ass", "w", encoding="utf-8") as f:
    f.writelines(lines)

print("saved captions.ass with", len(groups), "lines")

scene_word_bounds = [8, 16, 24, 35, 40, 48]
cuts = [0.0]
...
json.dump({"cuts": cuts, "durations": durations}, open("/Users/juliaknyazskaya/glp1-guide-site/ad-creatives/video2/scene_timing.json", "w"))
